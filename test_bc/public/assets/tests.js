...
define('test-fend/tests/components/table-item.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components');
  QUnit.test('components/table-item.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/table-item.js should pass jshint.');
  });
});
...
define('test-fend/tests/integration/components/table-item-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('table-item', 'Integration | Component | table item', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'table-item', ['loc', [null, [1, 0], [1, 14]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'table-item', [], [], 0, null, ['loc', [null, [2, 4], [4, 19]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('test-fend/tests/integration/components/table-item-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components');
  QUnit.test('integration/components/table-item-test.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/table-item-test.js should pass jshint.');
  });
});
...
define('test-fend/tests/routes/application.jshint', ['exports'], function (exports) {
  'use strict';
...
define('test-fend/tests/unit/routes/application-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
...
define('test-fend/tests/unit/routes/application-test.jshint', ['exports'], function (exports) {
  'use strict';
